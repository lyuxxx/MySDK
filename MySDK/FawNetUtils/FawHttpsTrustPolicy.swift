...
/// 服务器认证策略
public enum FawServerTrustPolicy {
    ...
    public func evaluate(_ serverTrust: SecTrust, forHost host: String) -> Bool {
        ...
        case let .pinPublicKeys(cerPath, validateCertificateChain, validateHost):
            ...
            guard
                ...
                let pinnedPublicKey = FawServerTrustPolicy.publicKey(for: pinnedCertificate) else {
                    return false
            }
            ...
            if certificateChainEvaluationPassed {
                outerLoop: for serverPublicKey in FawServerTrustPolicy.publicKeys(for: serverTrust) as [AnyObject] {
